<%-- 
    ...
    Created on : May 28, 2021, 5:41:20 PM
    Author     : Aniket kolte
--%>
...
<body>
        ...
        <div class="form-wrapper">
            ...
            <br>
             ...
             <form name="myForm" method="post" action="customer_login" onsubmit="return validateForm()">
            ...
            <h4>Click here to <a href="registration.jsp">REGISTER</a></h4>
                                    <br>
